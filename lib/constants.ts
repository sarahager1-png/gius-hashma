...
export const INSTITUTION_LEVELS = ['גן ילדים', 'יסודי', 'חט"ב', 'תיכון'] as const
export const SPECIALIZATIONS: Specialization[] = ['גן ילדים', 'יסודי', 'חט"ב', 'תיכון', 'מתמטיקה', 'אנגלית', 'חינוך מיוחד', 'תושב"ע', 'יעוץ', 'אחר']
