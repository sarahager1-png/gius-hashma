...
const ADMIN_TOOLS = [
  ...
  },
  {
    icon: MessageCircle,
    title: 'ערוץ תקשורת',
    desc: 'כל מועמדת ומוסד בוחרים בפרופיל: WhatsApp או SMS בלבד — עדכון מגיע רק לערוץ שנבחר',
...
const DASHBOARDS = [
  {
    ...
    items: [
      ...
      'פיד פעילות אחרונה + פעולות מהירות לכל הכלים',
    ],
  },
  {
    title: 'ניהול יישויות',
    items: [
      ...
      'כל המועמדות + פרופיל מלא + קורות חיים',
      'כל המשרות + מספר הגשות + סטטוס',
    ],
  },
  {
    title: 'תהליך הגיוס המלא',
    items: [
      'מעקב סטטוס: ממתינה → נצפתה → ראיון → התקבלה / נדחתה',
      'ראיונות — רשימה ולוח שנה חודשי',
      'דוחות שיבוצים — מגמות, ייצוא CSV',
    ],
  },
  {
    title: 'תקשורת ומשוב',
    items: [
      'הודעות ישירות — inbox פנימי בין מוסד למועמדת',
      'WhatsApp + SMS + מייל — אוטומטי בכל שינוי סטטוס',
      'התראות דפדפן (Web Push) — גם כשהאפליקציה סגורה',
      'סקרי שביעות רצון — נשלחים 30 יום לאחר שיבוץ',
      'דף תוצאות משוב — דירוגים, המלצות, הערות',
    ],
  },
  {
    title: 'כלי אדמין',
    items: [
      'ייבוא CSV — מועמדות בכמות',
      'קודי גישה + ניהול מנהלי מערכת',
      'יומן פעולות — מי, מה, מתי',
      'הרצת מיגרציות ואפשרויות מתקדמות',
    ],
  },
]
